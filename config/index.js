...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx1570cba7a09eec0e',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '5364bbd1f9b7562c522619ac6cfa58ed',
  ...
  USERS: [
    {
      ...
      id: 'oe9Em6lNcf7BRWoZOpNWFAkLBggQ',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '5LRg7Fv0jd2OV5NGDX-XurRuxjzKyQQIxHJqOie4YB8',
      // 所在省份
      province: '广西',
      // 所在城市
      city: '桂林',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '珍珍', year: '1998', date: '05-25',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2022', date: '08-11',
        },
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2022-08-11' },
        // 结婚纪念日
